    ...
    public partial class Form1 : Form
    {
        ...
        private void 도움말보기전체ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            richTextBox2.Text = "한글스크립트 C#버전 사용법\n\n" +
                ...
                "변수: 값을 담고 있는 것 입니다. 여기서 변수는 정수와 실수 문자를 담을 수 있습니다. 자세한 내용은 변수 도움말 참고\n" +
                "말하기: 지정한 변수를 말합니다. 자세한 내용은 말하기 도움말 참고\n" +
                "조건문: 만약 ~~하다면 ~~해라 라는 것 입니다. 자세한 내용은 조건문 도움말 참고" +
                "이동: 지정한 줄로 이동합니다. 자세한 내용은 이동 도움말 참고\n";
        }
        ...
        private void 도움말보기변수ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            richTextBox2.Text = "변수 도움말\n\n" +
                ...
                "변수 삭제\n" +
                "변수 삭제: 지정한 변수를 삭제합니다 \"모두 를 이용해 변수 전체를 삭제 할 수 있습니다";
        }
